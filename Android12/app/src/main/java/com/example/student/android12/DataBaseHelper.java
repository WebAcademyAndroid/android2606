...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private long insert(Student student) {
        return insert(student, getReadableDatabase());
    }
    ...
    public Student getStudent(long id) {
        ...
        try {
            cursor = db.query(Student.TABLE_NAME, null, Student.COLUMN_ID + "=" + id, null,
                    null, null, null);
            if (cursor.moveToFirst()) {
                student = new Student();
                student.id = cursor.getLong(cursor.getColumnIndex(Student.COLUMN_ID));
    ...
    public Widget getWidget(int id) {
        ...
        try {
            cursor = db.query(Widget.TABLE_NAME, null, Widget.COLUMN_ID_WIDGET + "=" + id, null,
                    null, null, null);
            if (cursor.moveToFirst()) {
                widget = new Widget();
    ...
    public ArrayList<Widget> getWidgets(long id) {
        ...
        try {
            cursor = db.query(Widget.TABLE_NAME, null, Widget.COLUMN_ID_STUDENT + "=" + id, null,
                    null, null, null);
            if (cursor.moveToFirst()) {
                while (!cursor.isAfterLast()) {
